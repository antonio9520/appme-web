...
export default ({ active }) => (
  <svg
    ...
    viewBox="0 0 110 110"
    version="1.1"
    className={active === "noti" ? "icon-sidebar-active" : "img-icon"}
  >
    <defs>
    ...
    <g
      id="AppMe-Admin-Platform-Icon-Notificaciones-1"
      clip-path="url(#clip-AppMe-Admin-Platform-Icon-Notificaciones-1)"
    >
      <g id="notification" transform="translate(-32.848 12)">
        ...
        <g
          id="Grupo_489"
          data-name="Grupo 489"
          transform="translate(67.184 35.639)"
        >
          <g id="Grupo_488" data-name="Grupo 488" transform="translate(0)">
            <path
              id="Trazado_441"
              data-name="Trazado 441"
              d="M135.515,213.791a1.667,1.667,0,0,0-1.667,1.667v.035a1.667,1.667,0,0,0,3.334,0v-.035A1.667,1.667,0,0,0,135.515,213.791Z"
        ...
        <g
          id="Grupo_491"
          data-name="Grupo 491"
          transform="translate(68.66 17.003)"
        >
          <g id="Grupo_490" data-name="Grupo 490" transform="translate(0)">
            <path
              id="Trazado_442"
              data-name="Trazado 442"
              d="M161.565,102a20.312,20.312,0,0,0-18.728,12.4,1.667,1.667,0,1,0,3.069,1.3,16.984,16.984,0,0,1,15.659-10.365,1.667,1.667,0,0,0,0-3.334Z"
              transform="translate(-142.705 -101.999)"
              stroke-width="0.5"
            />
          </g>
        </g>
